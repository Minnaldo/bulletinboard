...
class ArticleServiceTest {
    ...
    @InjectMocks private ArticleService sut;     // Mok 을 주입하는 대상을 InjectMocks

    @Mock private ArticleRepository articleRepository;  // 그 외 나머지 Mock
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        // Given
        ArticleDto dto = ArticleDto.of(LocalDateTime.now(), "ChoMin", "title", "content", "#java");
